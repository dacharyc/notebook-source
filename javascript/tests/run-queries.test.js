...
describe('Run Queries Tests', () => {
    it('Should return the expected ANN query results', async () => {
        ...
        const expectedResult = ['{"plot":"A reporter, learning of time travelers visiting 20th century disasters, tries to change the history they know by averting upcoming disasters.","title":"Thrill Seekers","score":0.7892671227455139}',
    ...
    it('Should return the expected ANN query with filter results', async () => {
        ...
        const expectedResult = ['{"plot":"In this magical tale about the boy who refuses to grow up, Peter Pan and his mischievous fairy sidekick Tinkerbell visit the nursery of Wendy, Michael, and John Darling. With a sprinkling ...","title":"Peter Pan","year":1960,"score":0.748110830783844}',
